            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div class="flex items-center justify-around text-sm">
                    <div class="text-center">
                        <p class="text-2xl font-bold text-emerald-600" id="checked-count">{{ \App\Models\Registration::where('event_id', $event->id)->where('status', 'attended')->count() }}</p>
                        <p class="text-gray-500">Checked In</p>
                    </div>
                    <div class="border-r border-gray-200 h-10"></div>
                    <div class="text-center">
                        <p class="text-2xl font-bold text-gray-900" id="total-count">{{ \App\Models\Registration::where('event_id', $event->id)->count() }}</p>
